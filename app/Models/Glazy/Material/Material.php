...
*/
    ...
    {
        return $this->hasOne('App\Models\Glazy\Material\MaterialAnalysis');
    }

    public function atmospheres()
    {
        return $this->belongsToMany('App\Models\Glazy\Material\Atmosphere', 'material_atmospheres');
    }

    public function shallowComponents()
    {
        return $this->hasMany('App\Models\Glazy\Material\MaterialMaterial', 'parent_material_id')
    ...
    {
        return $this->belongsToMany('App\Models\Glazy\Material\Material', 'material_materials');
    }

    public function material_type()
    {
        return $this->belongsTo('App\Models\Glazy\Material\MaterialType');
    }

    public function from_orton_cone()
    {
        return $this->belongsTo('App\Models\Glazy\Material\OrtonCone');
    }
    ...
    {
        return $this->belongsTo('App\Models\Glazy\Material\SurfaceType');
    }

    public function transparency_type()
    {
        return $this->belongsTo('App\Models\Glazy\Material\TransparencyType');
    }

    public function thumbnail()
    {
        return $this->belongsTo('App\Models\Glazy\Material\MaterialImage');
    }

    public function images()
    {
        return $this->hasMany('App\Models\Glazy\Material\MaterialImage', 'material_id');
    }

    public function collections()
    {
        return $this->belongsToMany('App\Models\Glazy\Material\Collection', 'collection_materials');
    }

    public function reviews()
    {
        return $this->hasMany('App\Models\Glazy\Material\MaterialReview', 'material_id');
    }
